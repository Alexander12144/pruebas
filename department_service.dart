...
class DepartmentService {
  Future getAllDepartment() async {
    Uri url = getURL('load_departamento');
    ...
    try {
      ...
      if (response.statusCode == 200) {
        debugPrint("Descargando Departamentos...");
        await SqlDb().deleteData("DELETE FROM Departamento");
        ...
        debugPrint("Error: DepartmentService -> ${response.statusCode}");
      }
    } catch (e) {
      debugPrint("Error: DepartmentService -> $e");
    }
  }
}

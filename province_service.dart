  ...
  Future getAllProvince() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        debugPrint("Descargando Provincias...");
        await SqlDb().deleteData("DELETE FROM Provincia");
        ...
        debugPrint("Error: StudyProvince -> ${response.statusCode}");
      }
    } catch (e) {
      debugPrint("Error: StudyProvince -> $e");
    }
  }
}

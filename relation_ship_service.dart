...
class RelationShipService {
  Future getAllRelationShip() async {
    Uri url = getURL('load_parentesco');
    ...
    try {
      ...
      if (response.statusCode == 200) {
        debugPrint("Descargando Parentesco...");
        await SqlDb().deleteData("DELETE FROM Parentesco");
        ...
        debugPrint("Error: RelationShipService -> ${response.statusCode}");
      }
    } catch (e) {
      debugPrint("Error: RelationShipService -> $e");
    }
  }
}
